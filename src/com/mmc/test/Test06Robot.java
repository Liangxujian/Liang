...
public class Test06Robot {
	public static void main(String[] args) throws Exception {
		...
		keyPress(robot, KeyEvent.VK_ENTER); // 按下 enter 换行
		robot.delay(3000); // 等待 3秒
		keyPress(robot, KeyEvent.VK_W); // 按下 h 键
		robot.delay(1000); // 等待 2秒
		keyPress(robot, KeyEvent.VK_O); // 按下 e 键
		robot.delay(1000); // 等待 2秒
		keyPress(robot, KeyEvent.VK_X); // 按下 l 键
		robot.delay(1000); // 等待 2秒
		keyPress(robot, KeyEvent.VK_H); // 按下 l 键
		robot.delay(1000); // 等待 2秒
		keyPress(robot, KeyEvent.VK_N); // 按下 o 键
		robot.delay(1000); // 等待 2秒
		...
		keyPress(robot, KeyEvent.VK_ENTER); // 按下 enter 换行
		robot.delay(3000); // 等待 3秒
		keyPressString(robot, "................好像已经演示过了吧，呵呵    ");
		keyPress(robot, KeyEvent.VK_ENTER); // 按下 enter 换行
		robot.delay(3000); // 等待 3秒
